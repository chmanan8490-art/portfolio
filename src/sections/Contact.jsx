...
const contactInfo = [
  {
    icon: FaEnvelope,
    label: "Email",
    value: "manan65050@gmail.com",
    href: "mailto:manan65050@gmail.com",
  },
  {
    icon: FaPhone,
    label: "Phone",
    value: "+92 301 6505092",
    href: "tel:+923016505092",
  },
  {
    icon: FaMapMarkerAlt,
    label: "Location",
    value: "Kahnewal, Punjab, Pakistan",
    href: "https://www.google.com/maps/place/Khanewal,+Pakistan/@30.2949813,71.9360589,13z",
  },
];
    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto w-full">
          {/* Contact Form */}
          <div className="glass p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300 w-full">
            <form className="space-y-6 w-full" onSubmit={handleSubmit}>
             ...
             <Button
  className="w-full flex items-center justify-center flex-wrap sm:flex-nowrap gap-2"
  type="submit"
  size="lg"
  disabled={isLoading}
>
  {isLoading ? (
    ...
    <>
      ...
      <FaPaperPlane className="w-4 h-4 sm:w-5 sm:h-5" />
          ...
          {/* Contact Info */}
         <div className="space-y-6 animate-fade-in animation-delay-400 w-full max-w-full px-4 sm:px-6 lg:px-0">
  {/* Contact Card */}
    ...
    <div className="space-y-3 sm:space-y-4">
      {contactInfo.map((item, i) => (
        <a
          key={i}
          href={item.href}
          className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl hover:bg-surface transition-colors group w-full"
        >
